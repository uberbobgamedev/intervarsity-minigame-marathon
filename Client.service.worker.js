...
/** @type {string} */
const CACHE_VERSION = '1769721942|4405889677';
/** @type {string} */
const CACHE_PREFIX = 'InterVarsity Min-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["Client.html","Client.js","Client.offline.html","Client.icon.png","Client.apple-touch-icon.png","Client.audio.worklet.js","Client.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Client.wasm","Client.pck"];
